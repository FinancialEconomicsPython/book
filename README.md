...
경제학적 직관은  **이론만으로도, 데이터만으로도 완성되지 않습니다.** 이 저장소가 독자 여러분이 직접 데이터를 다루고, 관련 읽을거리를 통해 현실과 연결하며, 금융경제학을 “이해하는 눈”을 기르는 데  
작은 도움이라도 되기를 바랍니다.
...
방법 A (가장 간단한 방법)
1. 주소창의 GitHub URL을 복사합니다. 예: https://github.com/FinancialEconomicsPython/chapters/ch01_example.ipynb
2. Google Colab에 접속합니다: https://colab.research.google.com
3. 상단 메뉴에서  
**파일 → 노트북 열기 → GitHub** 를 선택합니다.
4. URL을 붙여넣고 노트북을 엽니다.

#### 방법 B
1. Google Colab 첫 화면에서 **GitHub** 탭을 선택합니다.
2. 검색창에 `FinancialEconomicsPython`을 입력합니다.
3. 원하는 노트북을 선택하여 엽니다.
